...
// ================================= Image ====================================
gui::Image::Image(std::string texture, glm::vec2 size) : UINode(size), textureName(texture), uv(UVRegion()) {
    setInteractive(false);
}

gui::Image::Image(Texture* texture, glm::vec2 size) : UINode(size), texture(texture), uv(UVRegion()) {
    setInteractive(false);
}
