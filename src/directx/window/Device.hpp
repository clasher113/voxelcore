...
public:
	...
	static void setDepthBuffer(ID3D11DepthStencilView* depthStencil);
	static void setRenderTargets(ID3D11RenderTargetView* const* renderTargets, ID3D11DepthStencilView* depthStencil = nullptr,
		size_t renderTargetsCount = 1);
...
private:
	...
	static inline Microsoft::WRL::ComPtr<ID3D11SamplerState>		s_m_samplerPointWrap = nullptr;
	static inline Microsoft::WRL::ComPtr<ID3D11SamplerState>		s_m_samplerLinearWrap = nullptr;
	static inline Microsoft::WRL::ComPtr<ID3D11SamplerState>		s_m_samplerLinearClamp = nullptr;
	static inline Microsoft::WRL::ComPtr<ID3D11SamplerState>		s_m_samplerPointClamp = nullptr;
	static inline Microsoft::WRL::ComPtr<ID3D11SamplerState>		s_m_samplerStateComparison = nullptr;

	static inline size_t s_m_renderTargetViewsCount = 0;
	static inline ID3D11RenderTargetView* s_m_p_currentRenderTargetViews[D3D11_SIMULTANEOUS_RENDER_TARGET_COUNT];
